...
class StaffProfileUi extends StatefulWidget {
  @override
  _StaffProfileUiState createState() => _StaffProfileUiState();
}

class _StaffProfileUiState extends State<StaffProfileUi> {
  String _fullName = '';
  bool _isShown = true;
