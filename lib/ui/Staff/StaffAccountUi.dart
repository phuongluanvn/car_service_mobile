...
class StaffAccountUi extends StatefulWidget {
  // ManagerAccountUi() : super(key: key);

  @override
  _StaffAccountUiState createState() => _StaffAccountUiState();
}

class _StaffAccountUiState extends State<StaffAccountUi> {
  String _fullName = '';
  String _email = '';
  String _phoneNumber = '';
  String _dateOfBirth = '';
