...
const String CREATE_VEHICLE_FAIL = 'Thêm mới xe không thành công!';
const String IMAGE_URL_CUS = 'mobile_customer/cars/add_new_car/';
const String BUTTON_CREATE_TITLE = 'Thêm xe';
const String CREATE_CAR_TITLE_WIDGET = 'Thêm mới xe';
const String SELECT_MANU_TITLE = 'Chọn hãng xe';
const String SELECT_MODEL_TITLE = 'Chọn mẫu xe';
const String NOT_FOUND_MODEL = 'Không có mẫu xe cho hãng này';
const String CREATE_CAR_SUCCESS = 'Bạn đã thêm mới xe thành công!';
const String PATH_CUSTOMER_HOME = '/customer';
const String BUTTON_OK_TITLE = 'Đồng ý';
const String BUTTON_ACCEPT_TITLE = 'Xác nhận';
const String BUTTON_CANCEL_TITLE = 'Hủy';
const String BUTTON_DENY_TITLE = 'Hủy';
const String MANU_LABLE = 'Hãng xe';
const String MODEL_LABLE = 'Mẫu xe';
const String LICENSE_PLATE_LABLE = 'Biển số xe';
...
const String DELETE_VEHICLE_SUCCESS = 'Xóa thông tin xe thành công!';
const String UPDATE_VEHICLE_TITLE_WIDGET = 'Thông tin xe';
const String IMAGE_URL_UPDATE_VEHICLE_FIRST =
    'https://picsum.photos/400/200?image=1070';
const String IMAGE_URL_UPDATE_VEHICLE_SECOND =
    'https://picsum.photos/400/200?image=1071';

const String UPDATE_LAST_OF_MAINTENANCE_LABLE = 'Bảo dưỡng lần cuối';
const String UPDATE_MILLAGE_COUNT_LABLE = 'Số km ghi nhận gần nhất';
const String BUTTON_SAVE_UPDATE = 'Lưu';
const String NOT_FOUND_MODEL_SEARCH = 'Không tìm thấy mẫu xe';
const String NOT_FOUND_INFO_VEHICLE = 'Không có thông tin xe!';

//Manage vehicle
const String MANAGE_VEHICLE_WIDGET_TITLE = 'Danh sách xe';
...
//Card Info order
const String ORDER_INFO_CARD_TITLE = 'Thông tin đơn hàng';
const String ORDER_INFO_CARD_STATUS = 'Trạng thái đơn hàng: ';
const String ORDER_INFO_CARD_TIME_CREATE = 'Thời gian đặt hẹn: ';
const String ORDER_INFO_CARD_TIME_CHECKIN = 'Thời gian nhận xe: ';
